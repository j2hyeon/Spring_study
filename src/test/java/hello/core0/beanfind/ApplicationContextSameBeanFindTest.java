...
class ApplicationContextSameBeanFindTest {
    ...
    void findBeanByTypeDuplicate() {
        ...
        // => 중복되는 memberRepository1,memberRepository2가 오류로...
       //에외 터지면 성공
    ...
    // 같은 타입 -> 하나 꺼내기
    @Test
    @DisplayName("타입으로 조회시 같은 타입이 둘 이상 있으면, 꺼낼 빈 이름을 지정하면 된다")
    void findBeanByName() {
    ...
    @Configuration
    static class SameBeanConfig { // class안의 class -> 여기서만 쓰겠다 !
        @Bean
